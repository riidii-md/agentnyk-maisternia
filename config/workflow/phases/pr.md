...
created by `/work-change-review implementation-approval` for the exact implementation snapshot. Verify
...
evidence must fail readiness and return to
`/work-change-review implementation-approval`, `/work-run`, or `/work-review`
as appropriate. A chat approval or publication checkpoint is
